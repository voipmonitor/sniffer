...
#define FLAG_SAVEAUDIO		(1 << 3)
#define FLAG_FORMATAUDIO_WAV	(1 << 4)
#define FLAG_FORMATAUDIO_OGG	(1 << 5)
...
#define FLAG_SAVEGRAPH		(1 << 6)
#define FLAG_SAVERTPHEADER	(1 << 7)
#define FLAG_SKIPCDR		(1 << 8)
#define FLAG_RUNSCRIPT		(1 << 9)
#define FLAG_RUNAMOSLQO		(1 << 10)
#define FLAG_RUNBMOSLQO		(1 << 11)
#define FLAG_HIDEMESSAGE	(1 << 12)
