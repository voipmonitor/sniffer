1) Collecting stats into rrd files and creating graphs (note:rrd files will be automaticaly saved into your spool directory into subdir rrd)
	...
	Prerequisite:
	a) Installed librrd and rrdtool in your OS
	...
	b) in voipmonitor.conf check for option 'rrd' and set it to yes (default is yes)
		rrd = yes
...
2) How to create graphs from collected data?
	...
	b) You can create graphs that meets your specific needs using 'rrdtool graph'.
		For its syntax look at: http://oss.oetiker.ch/rrdtool/doc/rrdgraph.en.html
