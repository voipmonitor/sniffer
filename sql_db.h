...
struct sExistsColumns {
	...
	bool register_state_counter;
	bool register_state_created_at_ms;
	bool register_failed_created_at_ms;
	bool register_state_eq_next_created_at;
	bool register_state_eq_next_created_at_ms;
	bool register_state_eq_next_next_at_ms;
	bool register_failed_eq_next_created_at;
	bool register_failed_eq_next_created_at_ms;
	bool register_failed_eq_next_next_at_ms;
	bool register_rrd_count;
	bool register_state_spool_index;
	bool register_failed_spool_index;
	bool register_state_flags;
	bool register_failed_flags;
