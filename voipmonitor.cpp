...
int eval_config(string inistr) {
	...
	if((value = ini.GetValue("general", "cleandatabase_cdr_stat", NULL))) {
		opt_cleandatabase_cdr_stat = atoi(value);
	}
	...
	if((value = ini.GetValue("general", "mysqltransactions_sip_msg", NULL))) {
		opt_mysql_enable_transactions_sip_msg = yesno(value);
	}
	...
	*/
	...
	if((value = ini.GetValue("general", "pre_process_packets_next_thread_sem_sync", NULL))) {
		opt_pre_process_packets_next_thread_sem_sync = atoi(value) == 2 ? 2 :yesno(value);
	}
	...
	if((value = ini.GetValue("general", "response_default_timeout", NULL))) {
		opt_response_default_timeout = atoi(value);
	}
	...
	if((value = ini.GetValue("general", "mysqlstore_concat_limit_sip_msg", NULL))) {
		opt_mysqlstore_concat_limit_sip_msg = atoi(value);
	}
	...
	if((value = ini.GetValue("general", "mysqlstore_max_threads_sip_msg", NULL))) {
		opt_mysqlstore_max_threads_sip_msg = max(min(atoi(value), 99), 1);
	}
	...
	if((value = ini.GetValue("general", "cpu_limit_new_thread_if_heap_grows", NULL))) {
		opt_cpu_limit_new_thread_if_heap_grows = atoi(value);
	}
