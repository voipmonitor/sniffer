		...
		for (callMAPIT = calltable->calls_listMAP.begin(); callMAPIT != calltable->calls_listMAP.end(); ++callMAPIT) {
			...
			*/
			...
			outbuflen = sprintf(outbuf, 
					    ...
					    (call->lastcallerrtp and lastcallerrtp->stats.received ? (float)((double)call->lastcallerrtp->stats.lost / ((double)call->lastcallerrtp->stats.received + (double)call->lastcallerrtp->stats.lost) * 100.0) : 0),
					    ...
					    (call->lastcalledrtp and lastcalledrtp->stats.received > 50 ? (float)((double)call->lastcalledrtp->stats.lost / ((double)call->lastcalledrtp->stats.received + (double)call->lastcalledrtp->stats.lost) * 100.0) : 0),
