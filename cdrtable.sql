...
CREATE TABLE `cdr` (
  ...
  `a_rtcp_loss` int(8) unsigned DEFAULT NULL,
  `a_rtcp_maxfr` int(8) unsigned DEFAULT NULL,
  `a_rtcp_avgfr` float(8) unsigned DEFAULT NULL,
  `a_rtcp_maxjitter` int(8) unsigned DEFAULT NULL,
  `a_rtcp_avgjitter` float(8) unsigned DEFAULT NULL,
  `b_rtcp_loss` int(8) unsigned DEFAULT NULL,
  `b_rtcp_maxfr` int(8) unsigned DEFAULT NULL,
  `b_rtcp_avgfr` float(8) unsigned DEFAULT NULL,
  `b_rtcp_maxjitter` int(8) unsigned DEFAULT NULL,
  `b_rtcp_avgjitter` float(8) unsigned DEFAULT NULL,
  PRIMARY KEY  (`ID`),
  ...
  KEY `a_rtcp_avgfr` (`a_rtcp_avgfr`), 
  KEY `a_rtcp_maxjitter` (`a_rtcp_maxjitter`), 
  KEY `a_rtcp_avgjitter` (`a_rtcp_avgjitter`), 
  KEY `b_rtcp_loss` (`b_rtcp_loss`), 
  KEY `b_rtcp_maxfr` (`b_rtcp_maxfr`), 
  KEY `b_rtcp_avgfr` (`b_rtcp_avgfr`), 
  KEY `b_rtcp_maxjitter` (`b_rtcp_maxjitter`), 
  KEY `b_rtcp_avgjitter` (`b_rtcp_avgjitter`),
  KEY `a_mos_f1` (`a_mos_f1`),
  KEY `a_mos_f2` (`a_mos_f2`),
  KEY `a_mos_adapt` (`a_mos_adapt`),
  KEY `b_mos_f1` (`b_mos_f1`),
  KEY `b_mos_f2` (`b_mos_f2`),
  KEY `b_mos_adapt` (`b_mos_adapt`)
) ENGINE=InnoDB;
