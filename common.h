...
struct sVerbose {
	...
	int cdr_stat_interval_cleanup;
	int cdr_problems_only;
	int cdr_problems_interval_store;
	int cdr_problems_interval_cleanup;
	int cdr_summary_only;
	int cdr_summary_interval_store;
	int cdr_summary_interval_cleanup;
